...
use JanFastOrder\Resources\helper\TranslationHelper;
    ...
    public function getPayload(): array
    {
        ...
        return [
            [
                ...
                'productNumber' => 'JANFASTORDER10002',
                'active' => true,
                'taxId' => $taxId,
                'stock' => 10,
                'purchaseUnit' => 1.0,
            ...
            [
                ...
                'productNumber' => 'JANFASTORDER100013',
                'active' => false,
                'taxId' => $taxId,
                'stock' => 40,
                'purchaseUnit' => 250.0,
            ...
            [
                ...
                'productNumber' => 'JANFASTORDER10001',
                'active' => true,
                'taxId' => $taxId,
                'stock' => 10,
                'purchaseUnit' => 1.0,
            ...
            [
                ...
                'productNumber' => 'JANFASTORDER10006',
                'active' => true,
                'taxId' => $taxId,
                'stock' => 50,
                'purchaseUnit' => 1.0,
            ...
            [
                ...
                'productNumber' => 'JANFASTORDER10005',
                'active' => true,
                'taxId' => $taxId,
                'stock' => 50,
                'purchaseUnit' => 1.0,
                ...
                'children' => [
                    [
                        'productNumber' => 'JANFASTORDER10005.1',
                        'stock' => 50,
                        'options' => [
                            [
                    ...
                    [
                        'productNumber' => 'JANFASTORDER10005.2',
                        'stock' => 50,
                        'options' => [
                            [
                                'id' => '2bfd278e87204807a890da4a3e81dd90',
                    ...
                    [
                        'productNumber' => 'JANFASTORDER10005.3',
                        'stock' => 50,
                        'options' => [
                            [
                    ...
                    [
                        'productNumber' => 'JANFASTORDER10005.4',
                        'stock' => 50,
                        'options' => [
                            [
                                'id' => '52454db2adf942b2ac079a296f454a10',
                    ...
                    [
                        'productNumber' => 'JANFASTORDER10005.5',
                        'stock' => 50,
                        'options' => [
                            [
                    ...
                    [
                        'productNumber' => 'JANFASTORDER10005.6',
                        'stock' => 50,
                        'options' => [
                            [
                                'id' => 'ad735af1ebfb421e93e408b073c4a89a',
            ...
            [
                ...
                'productNumber' => 'JANFASTORDER10007',
                'active' => true,
                'taxId' => $taxId,
                'stock' => 50,
                'purchaseUnit' => 1.0,
                ...
                'children' => [
                    [
                        'productNumber' => 'JANFASTORDER10007.1',
                        'stock' => 50,
                        'options' => [
                            [
                                'id' => '41e5013b67d64d3a92b7a275da8af441',
                    ...
                    [
                        'productNumber' => 'JANFASTORDER10007.2',
                        'stock' => 50,
                        'options' => [
                            [
                                'id' => '54147692cbfb43419a6d11e26cad44dc',
                    ...
                    [
                        'productNumber' => 'JANFASTORDER10007.3',
                        'stock' => 50,
                        'options' => [
                            [
                                'id' => '5997d91dc0784997bdef68dfc5a08912',
                    ...
                    [
                        'productNumber' => 'JANFASTORDER10007.4',
                        'stock' => 50,
                        'options' => [
                            [
                                'id' => 'acfd7586d02848f1ac801f4776efa414',
        ...
        return [
            [
                ...
                'taxId' => $taxId,
                'stock' => rand(1, 100),
                'purchaseUnit' => rand(1, 10) * 1.0,
                'referenceUnit' => rand(1, 10) * 1.0,
                'shippingFree' => (bool)rand(0, 1),
                'purchasePrice' => rand(500, 1000) / 100,
                'weight' => rand(100, 1000) / 10,
                'width' => rand(100, 1000) / 10,
                'height' => rand(100, 1000) / 10,
                'length' => rand(100, 1000) / 10,
                'releaseDate' => new \DateTimeImmutable(),
                'displayInListing' => (bool)rand(0, 1),
                'name' => $this->translationHelper->adjustTranslations([
                    'de-DE' => 'Produkt ' . rand(1000, 9999),
                    'en-GB' => 'Product ' . rand(1000, 9999),
                    'pl-PL' => 'Produkt ' . rand(1000, 9999),
                ]),
                'description' => $this->translationHelper->adjustTranslations([
                    'de-DE' => self::LOREM_IPSUM,
                    'en-GB' => self::LOREM_IPSUM,
                ...
                'manufacturer' => [
                    'id' => Uuid::randomHex(),
                    'name' => $this->translationHelper->adjustTranslations([
                        'de-DE' => 'Hersteller ' . rand(1000, 9999),
                        'en-GB' => 'Manufacturer ' . rand(1000, 9999),
                        'pl-PL' => 'Producent ' . rand(1000, 9999),
                    ]),
                ],
                'media' => [
                    [
                ...
                'price' => [[
                    'net' => rand(1000, 5000) / 100,
                    'gross' => rand(1000, 5000) / 100,
                    'linked' => true,
                    'currencyId' => Defaults::CURRENCY,
                ]],
                'prices' => [
            ...
            [
                'id' => Uuid::randomHex(),
                'productNumber' => 'JANFASTORDER10003',
                'active' => true,
                'taxId' => $taxId,
                'stock' => rand(1, 100),
                'purchaseUnit' => rand(1, 10) * 1.0,
            ...
            // Continue with more products in similar fashion...
            // Ensure each product has a unique `productNumber` and `id`.
        ];
    }
